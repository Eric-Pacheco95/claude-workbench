...
- --market: tune for financial/trading content -- focus on actionable signals, trend shifts, risk factors, and macro regime changes; de-prioritize general financial literacy content that is widely known
...
- --count N: override default output count (default: 15 bullets); useful for shorter content

## Examples
- /extract-alpha <paste article text>
- /extract-alpha docs/research_brief.md
...
**--market mode:**
- Prioritize: specific price levels or ranges cited with rationale, macro regime signals (rate expectations, dollar strength, liquidity), sentiment extremes with measurable backing, pattern breaks vs. historical cycles, risk asymmetries
- Deprioritize: generic volatility statements, standard TA descriptions without novel context
