...
14. **Log all significant decisions** to `history/decisions/` with rationale
15. **Alert on anomalies** -- unexpected permission requests, unusual file access patterns, repeated failures
